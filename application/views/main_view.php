...
<div class="splash-container">
    <div class="splash">
        <h1 class="splash-head">Welcome to Gemriser</h1>
        <p class="splash-subhead">
            GEMRISER is A smart and tiny PHP framework.
        </p>
        <p>
        <form class="pure-form">
            <input type="text" value="application/views/header.php----> header view file's" readonly>
